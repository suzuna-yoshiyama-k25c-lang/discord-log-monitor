...
WEBHOOK_URL = 'https://discord.com/api/webhooks/1521011383737520208/ETeKWINyjuUkennyuiMUwkTNiQuPA8TH1R3xE1BroncXLsBn5MQuQtnH0zHsswLNPLAH'
# ==========================================
...
with open("/var/log/secure", "r") as f:
    ...
    while True:
        line = f.readline()  # ★ループの中で毎回、新しい書き込みを1行読み込む！
...
# 🌟 【実践機能】ログイン成功（突破）を検知したら通知！
        elif "Accepted password" in line:
            print("🔓 ログイン成功を検知しました！")
            send_discord("🔓 【超重要】サーバーへのログイン成功（侵入）が検知されました！")
